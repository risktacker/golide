...
export function Header({ utility }: { utility?: ReactNode } = {}) {
  return <header className="site-header"><div className="shell nav-wrap"><Logo/><nav className="desktop-nav" aria-label="Primary navigation"><a href="https://golidee.com/">Ventures</a><a href="https://golidee.com/research">Research</a><a href="https://golidee.com/founder">Founder</a><a href="https://golidee.com/studio">Studio</a><AccountControl/></nav>{utility}<a className="nav-cta" href="https://marketplace.golidee.com/">Marketplace <ArrowUpRight size={15}/></a><details className="mobile-menu"><summary aria-label="Open menu"><Menu size={22}/></summary><nav><a href="https://golidee.com/">Ventures</a><a href="https://golidee.com/research">Research</a><a href="https://golidee.com/founder">Founder</a><a href="https://golidee.com/studio">Studio</a><AccountControl/></nav></details></div></header>;
}

export function Footer() { return <footer><div className="shell footer-top"><div><Logo/><p>A founder-led ecosystem for software, markets and research.</p></div><div className="footer-links"><div><strong>Explore</strong><a href="https://marketplace.golidee.com/">Marketplace</a><a href="https://golidee.com/research">Research</a><a href="https://golidee.com/founder">Founder</a></div><div><strong>Systems</strong><a href="https://golidee.com/content-engine">Content Engine</a><a href="https://golidee.com/privacy">Privacy</a><a href="https://golidee.com/terms">Terms</a></div><div><strong>Connect</strong><a href="https://github.com/risktacker/golide" target="_blank" rel="noreferrer">GitHub</a><a href="mailto:esiahsbusiness@gmail.com">Email</a></div></div></div><div className="shell footer-bottom"><span>© 2026 G$LIDE. Built from Lusaka.</span><span>Knowledge → Systems → Value</span></div></footer>; }
